...
- **Story 4** — API 계층 테스트 방식: 결정 @WebMvcTest 컨트롤러 슬라이스 → [ADR-008](../../../adr/adr-008-api-test-webmvc-slice.md)
...
- **API 계층 테스트 방식** — 결정: @WebMvcTest 컨트롤러 슬라이스 → [ADR-008](../../../adr/adr-008-api-test-webmvc-slice.md)
